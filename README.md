...
# Express+IO+Terminal
>Base express, para crear un código web encima de una estructura existente de express 
>Pulsando "\" aparece un terminal donde porder interacturar con NODEJS
>start in /src/index.js
>and html web /src/www/spartan/views/index.ejs
>## Libs depends 
>* electron
...
>* http
>* web-terminaljs
> ejample: npm install electron electron-packager express ejs socket.io http web-terminaljs
>## Build
>Windows: npm run build
>## Developer
>npm run dev
...
>## web-terminaljs
> Its a other proyect
> URL:  https://github.com/oztar/node_web-terminaljs
>##express 
>using ejs render 
> ### theme structure
> path theme : .../src/www/{name}/...
...
> | title | value | Default |
> |-------|-------------|---|
> | env | environment value['dev'|none] | node |
> | webtheme | is a name of folder /src/www/{value}/** | spartan |
> | name | title window | NodeBaseInterface |
> | version | name version* | v2_base_express |
> | publicIP | IP server express | localhost |
> | port | port express and io | random |
> | uri | url comunication internal backend - frontend | localhost:port |
>
> \* Only for render example
> 